...
- [ ] Интернационализация и мультиязычный UI (ожидается в августе)
- [ ] Многоязычная документация (ожидается в августе)
- [ ] Обмен агентами (ожидается в августе)
- [ ] Мониторинг производительности и сбор крэш-репортов (ожидается в августе)
- [ ] Управление правами (ожидается в сентябре)
- [ ] Встроенный Token-Plan (ожидается в октябре)
